...
export const PRODUCT_IMAGES: Record<string, string[]> = {
  // Amul Taaza Toned Milk 500 ml (Zepto CDN)
  "AMUL-DAIRY-001": [
    "/products/AMUL-DAIRY-001.webp",
    "/products/AMUL-DAIRY-001_2.webp",
    "/products/AMUL-DAIRY-001_3.webp",
  ],

  // Amul Gold Full Cream Milk 1 L (Zepto CDN)
  "AMUL-DAIRY-002": [
    "/products/AMUL-DAIRY-002.webp",
  ],

  // Amul Masti Dahi 400 g (Zepto CDN)
  "AMUL-DAIRY-003": [
    "/products/AMUL-DAIRY-003.webp",
  ],

  // Amul Malai Paneer Block 200 g (Zepto CDN)
  "AMUL-DAIRY-004": [
    "/products/AMUL-DAIRY-004.webp",
  ],

  // Amul Butter (Salted) 100 g (Zepto CDN)
  "AMUL-DAIRY-005": [
    "/products/AMUL-DAIRY-005.webp",
  ],

  // Nestlé A+ Slim Toned Milk 1 L (Zepto CDN)
  "NEST-DAIRY-006": [
    "/products/NEST-DAIRY-006.webp",
  ],

  // India Gate Classic Basmati Rice 5 kg (Zepto CDN)
  "INDI-STPL-001": [
    "/products/INDI-STPL-001.webp",
  ],

  // Aashirvaad Shudh Chakki Atta 5 kg (Zepto CDN)
  "AASH-STPL-002": [
    "/products/AASH-STPL-002.webp",
  ],

  // Tata Salt — Iodised, 1 kg (Zepto CDN)
  "TATA-STPL-003": [
    "/products/TATA-STPL-003.webp",
  ],

  // Toor Dal (Arhar) 1 kg (Zepto CDN)
  "TOOR-STPL-004": [
    "/products/TOOR-STPL-004.webp",
  ],

  // Chana Dal 500 g (Zepto CDN)
  "CHAN-STPL-005": [
    "/products/CHAN-STPL-005.webp",
  ],

  // Madhur Pure & Hygienic Sugar 1 kg (Zepto CDN)
  "MADH-STPL-006": [
    "/products/MADH-STPL-006.webp",
  ],

  // Cold-Pressed Groundnut Oil 500 ml (Zepto CDN)
  "COLD-STPL-007": [
    "/products/COLD-STPL-007.webp",
  ],

  // Fortune Sunlite Refined Sunflower Oil 1 L (Zepto CDN)
  "FORT-STPL-008": [
    "/products/FORT-STPL-008.webp",
  ],

  // Rajma Chitra 500 g (Zepto CDN)
  "RAJM-STPL-009": [
    "/products/RAJM-STPL-009.webp",
  ],

  // Poha (Flattened Rice) 500 g (Zepto CDN)
  "POHA-STPL-010": [
    "/products/POHA-STPL-010.webp",
  ],

  // Onion (Pyaz) 1 kg (Zepto CDN)
  "ONIO-PROD-001": [
    "/products/ONIO-PROD-001.webp",
  ],

  // Tomato (Tamatar) 1 kg (Zepto CDN)
  "TOMA-PROD-002": [
    "/products/TOMA-PROD-002.webp",
    "/products/TOMA-PROD-002_2.webp",
    "/products/TOMA-PROD-002_3.webp",
  ],

  // Potato (Aloo) 1 kg (Zepto CDN)
  "POTA-PROD-003": [
    "/products/POTA-PROD-003.webp",
    "/products/POTA-PROD-003_2.webp",
    "/products/POTA-PROD-003_3.webp",
  ],

  // Loose Ginger (Adrak) 100 g (Zepto CDN)
  "GING-PROD-004": [
    "/products/GING-PROD-004.webp",
  ],

  // Garlic (Lehsun) 200 g (Zepto CDN)
  "GARL-PROD-005": [
    "/products/GARL-PROD-005.webp",
  ],

  // Banana (Kela) — 6 pcs (Zepto CDN)
  "BANA-PROD-006": [
    "/products/BANA-PROD-006.webp",
  ],

  // Coriander Leaves (Hara Dhania) 100 g (Zepto CDN)
  "CORI-PROD-007": [
    "/products/CORI-PROD-007.webp",
  ],

  // Green Chilli (Hari Mirch) 100 g (Zepto CDN)
  "GREE-PROD-008": [
    "/products/GREE-PROD-008.webp",
  ],

  // Lemon (Nimbu) — 4 pcs (Zepto CDN)
  "LEMO-PROD-009": [
    "/products/LEMO-PROD-009.webp",
  ],

  // Maggi 2-Minute Masala Noodles (Pack of 4) (Zepto CDN)
  "MAGG-SNCK-001": [
    "/products/MAGG-SNCK-001.webp",
  ],

  // Britannia 50-50 Maska Chaska 120 g (Zepto CDN)
  "BRIT-SNCK-002": [
    "/products/BRIT-SNCK-002.webp",
  ],

  // Haldiram's Aloo Bhujia 200 g (Zepto CDN)
  "HALD-SNCK-003": [
    "/products/HALD-SNCK-003.webp",
  ],

  // Lay's India's Magic Masala 52 g (Zepto CDN)
  "LAYS-SNCK-004": [
    "/products/LAYS-SNCK-004.webp",
  ],

  // Parle-G Gold Biscuits 200 g (Zepto CDN)
  "PARL-SNCK-005": [
    "/products/PARL-SNCK-005.webp",
  ],

  // Kellogg's Chocos 375 g (Zepto CDN)
  "KELL-SNCK-006": [
    "/products/KELL-SNCK-006.webp",
  ],

  // Tata Tea Gold 500 g (Zepto CDN)
  "TATA-BEVG-001": [
    "/products/TATA-BEVG-001.webp",
  ],

  // Nescafé Classic Instant Coffee 50 g (Zepto CDN)
  "NESC-BEVG-002": [
    "/products/NESC-BEVG-002.webp",
  ],

  // Coca-Cola 750 ml (Zepto CDN)
  "COCA-BEVG-003": [
    "/products/COCA-BEVG-003.webp",
  ],
  ...
  "BRIT-BAKE-001": [
    "/products/BRIT-BAKE-001.webp",
  ],

  // Surf Excel Easy Wash Detergent Powder 1 kg (Zepto CDN)
  "SURF-HHLD-001": [
    "/products/SURF-HHLD-001.webp",
  ],

  // Vim Dishwash Bar 300 g (Zepto CDN)
  "VIM-HHLD-002": [
    "/products/VIM-HHLD-002.webp",
  ],

  // Harpic Power Plus Toilet Cleaner 500 ml (Zepto CDN)
  "HARP-HHLD-003": [
    "/products/HARP-HHLD-003.webp",
  ],

  // Nirma Washing Powder­ 1 kg (Zepto CDN)
  "NIRM-HHLD-004": [
    "/products/NIRM-HHLD-004.webp",
  ],

  // Colgate Strong Teeth Toothpaste 200 g (Zepto CDN)
  "COLG-PCAR-001": [
    "/products/COLG-PCAR-001.webp",
  ],

  // Dettol Original Soap — 4 × 125 g (Zepto CDN)
  "DETT-PCAR-002": [
    "/products/DETT-PCAR-002.webp",
  ],

  // Head & Shoulders Anti-Dandruff Shampoo 340 ml (Zepto CDN)
  "HEAD-PCAR-003": [
    "/products/HEAD-PCAR-003.webp",
  ],

  // Mother's Recipe Mango Pickle 400 g (Zepto CDN)
  "MOTH-COND-001": [
    "/products/MOTH-COND-001.webp",
  ],

  // MDH Garam Masala 100 g (Zepto CDN)
  "MDH-COND-002": [
    "/products/MDH-COND-002.webp",
  ],

  // Kissan Fresh Tomato Ketchup 950 g (Zepto CDN)
  "KISS-COND-003": [
    "/products/KISS-COND-003.webp",
  ],

  // Everest Haldi (Turmeric) Powder 200 g (Zepto CDN)
  "EVER-COND-004": [
    "/products/EVER-COND-004.webp",
  ],

  // Apple iPhone 17 Pro | 256 GB | Cosmic Orange (Zepto CDN)
  "APPL-ELEC-001": [
    "/products/APPL-ELEC-001.webp",
    "/products/APPL-ELEC-001_2.webp",
    "/products/APPL-ELEC-001_3.webp",
    "/products/APPL-ELEC-001_4.webp",
    "/products/APPL-ELEC-001_5.webp",
    "/products/APPL-ELEC-001_6.webp",
    "/products/APPL-ELEC-001_7.webp",
    "/products/APPL-ELEC-001_8.webp",
    "/products/APPL-ELEC-001_9.webp",
  ],

  // Freedom Refined Sunflower Oil (Zepto CDN)
  "FREE-STPL-011": [
    "/brand/brand_FREE-STPL-011_1.webp",
  ],

  // Fortune Kachi Ghani Mustard Oil | Bottle (Zepto CDN)
  "FORT-STPL-012": [
    "/brand/brand_FORT-STPL-012_1.webp",
  ],
  ...
  // Gemini Pure Refined Sunflower Oil 1 L (Zepto CDN)
  "GEMI-STPL-014": [
    "/brand/brand_FREE-STPL-011_1.webp",
  ],

  // Fortune Rice Bran Health Oil 1 L (Zepto CDN)
  "FORT-STPL-015": [
    "/products/FORT-STPL-015.webp",
  ],

  // Emami Healthy & Tasty Rice Bran Oil 1 L (Zepto CDN)
  "EMAM-STPL-016": [
    "/products/EMAM-STPL-016.webp",
  ],

  // Freedom Refined Sunflower Oil 1 L (Zepto CDN)
  "FREE-STPL-017": [
    "/brand/brand_FREE-STPL-011_1.webp",
  ],

  // Fortune Kachi Ghani Mustard Oil 1 L (Zepto CDN)
  "FORT-STPL-018": [
    "/brand/brand_FORT-STPL-012_1.webp",
  ],

  // Amul Masti Spiced Buttermilk 200 ml (Zepto CDN)
  "AMUL-DAIRY-007": [
    "/products/AMUL-DAIRY-007.webp",
  ],

  // Amul Shrikhand Kesar 500 g (Zepto CDN)
  "AMUL-DAIRY-008": [
    "/products/AMUL-DAIRY-008.webp",
  ],

  // Amul Masti Dahi (Curd) 400 g (Zepto CDN)
  "AMUL-DAIRY-009": [
    "/products/AMUL-DAIRY-009.webp",
  ],

  // Amul Pure Cow Ghee 500 ml (Zepto CDN)
  "AMUL-DAIRY-010": [
    "/products/AMUL-DAIRY-010.webp",
  ],

  // Mother Dairy Full Cream Milk 1 L (Zepto CDN)
  "MOTH-DAIRY-011": [
    "/products/MOTH-DAIRY-011.webp",
  ],

  // Mother Dairy Classic Dahi 400 g (Zepto CDN)
  "MOTH-DAIRY-012": [
    "/products/MOTH-DAIRY-012.webp",
  ],

  // Amul Cheese Slices (Pack of 10) 200 g (Zepto CDN)
  "AMUL-DAIRY-013": [
    "/products/AMUL-DAIRY-013.webp",
  ],

  // Amul Processed Cheese Block 200 g (Zepto CDN)
  "AMUL-DAIRY-014": [
    "/products/AMUL-DAIRY-014.webp",
  ],

  // Amul Fresh Cream 250 ml (Zepto CDN)
  "AMUL-DAIRY-015": [
    "/products/AMUL-DAIRY-015.webp",
  ],

  // Amul Kool Kesar Flavoured Milk 180 ml (Zepto CDN)
  "AMUL-DAIRY-016": [
    "/products/AMUL-DAIRY-016.webp",
  ],

  // Mother Dairy Rabri 200 g (Zepto CDN)
  "MOTH-DAIRY-017": [
    "/products/MOTH-DAIRY-017.webp",
  ],

  // Milky Mist Greek Yogurt Natural 100 g (Zepto CDN)
  "MILK-DAIRY-018": [
    "/products/MILK-DAIRY-018.webp",
  ],

  // Epigamia Greek Yogurt Blueberry 90 g (Zepto CDN)
  "EPIG-DAIRY-019": [
    "/products/EPIG-DAIRY-019.webp",
  ],

  // Nestle A+ Slim Skimmed Milk 1 L (Zepto CDN)
  "NEST-DAIRY-020": [
    "/products/NEST-DAIRY-020.webp",
  ],

  // Amul Lassi (Tetra Pack) 250 ml (Zepto CDN)
  "AMUL-DAIRY-021": [
    "/products/AMUL-DAIRY-021.webp",
  ],

  // Gowardhan Desi Ghee 1 L (Zepto CDN)
  "GOWA-DAIRY-022": [
    "/products/GOWA-DAIRY-022.webp",
  ],

  // Amul Mithai Mate (Condensed Milk) 200 g (Zepto CDN)
  "AMUL-DAIRY-023": [
    "/products/AMUL-DAIRY-023.webp",
  ],

  // Britannia Cheese Block 200 g (Zepto CDN)
  "BRIT-DAIRY-024": [
    "/products/BRIT-DAIRY-024.webp",
  ],

  // Aashirvaad Sharbati Atta 5 kg (Zepto CDN)
  "AASH-STPL-019": [
    "/products/AASH-STPL-019.webp",
  ],

  // Fortune Besan (Gram Flour) 500 g (Zepto CDN)
  "FORT-STPL-020": [
    "/products/FORT-STPL-020.webp",
  ],

  // Tata Sampann Moong Dal (Split) 500 g (Zepto CDN)
  "TATA-STPL-021": [
    "/products/TATA-STPL-021.webp",
  ],

  // Tata Sampann Urad Dal (White Split) 500 g (Zepto CDN)
  "TATA-STPL-022": [
    "/products/TATA-STPL-022.webp",
  ],

  // Tata Sampann Masoor Dal 500 g (Zepto CDN)
  "TATA-STPL-023": [
    "/products/TATA-STPL-023.webp",
  ],

  // Kabuli Chana (Chickpeas) 500 g (Zepto CDN)
  "KABU-STPL-024": [
    "/products/KABU-STPL-024.webp",
  ],

  // Kala Chana (Brown Gram) 500 g (Zepto CDN)
  "KALA-STPL-025": [
    "/products/KALA-STPL-025.webp",
  ],

  // Daawat Rozana Super Basmati Rice 1 kg (Zepto CDN)
  "DAAW-STPL-026": [
    "/products/DAAW-STPL-026.webp",
  ],

  // Sona Masoori Raw Rice 5 kg (Zepto CDN)
  "SONA-STPL-027": [
    "/products/SONA-STPL-027.webp",
  ],

  // Tata Rock Salt (Sendha Namak) 1 kg (Zepto CDN)
  "TATA-STPL-028": [
    "/products/TATA-STPL-028.webp",
  ],

  // Saffola Gold Pro Healthy Lifestyle Edible Oil 1 L (Zepto CDN)
  "SAFF-STPL-029": [
    "/products/SAFF-STPL-029.webp",
  ],

  // Dhara Mustard Oil 1 L (Zepto CDN)
  "DHAR-STPL-030": [
    "/products/DHAR-STPL-030.webp",
  ],

  // Organic Jaggery Powder (Gur) 500 g (Zepto CDN)
  "JAGG-STPL-031": [
    "/products/JAGG-STPL-031.webp",
  ],

  // Sooji (Semolina / Rava) 500 g (Zepto CDN)
  "SOOJ-STPL-032": [
    "/products/SOOJ-STPL-032.webp",
  ],

  // Maida (Refined Wheat Flour) 500 g (Zepto CDN)
  "MAID-STPL-033": [
    "/products/MAID-STPL-033.webp",
  ],

  // Sabudana (Tapioca Sago) 500 g (Zepto CDN)
  "SABU-STPL-034": [
    "/products/SABU-STPL-034.webp",
  ],

  // Bambino Roasted Vermicelli 400 g (Zepto CDN)
  "BAMB-STPL-035": [
    "/products/BAMB-STPL-035.webp",
  ],

  // Fortune Soya Badi (Chunks) 200 g (Zepto CDN)
  "FORT-STPL-036": [
    "/products/FORT-STPL-036.webp",
  ],

  // Cauliflower (Phool Gobhi) 1 pc (Zepto CDN)
  "CAUL-PROD-010": [
    "/products/CAUL-PROD-010.webp",
  ],

  // Cabbage (Patta Gobhi) 1 pc (Zepto CDN)
  "CABB-PROD-011": [
    "/products/CABB-PROD-011.webp",
  ],

  // Lady Finger (Bhindi / Okra) 500 g (Zepto CDN)
  "LADY-PROD-012": [
    "/products/LADY-PROD-012.webp",
  ],

  // Green Capsicum (Shimla Mirch) 500 g (Zepto CDN)
  "GREE-PROD-013": [
    "/products/GREE-PROD-013.webp",
  ],

  // Carrot (Gajar) 500 g (Zepto CDN)
  "CARR-PROD-014": [
    "/products/CARR-PROD-014.webp",
  ],

  // Cucumber (Kheera) 500 g (Zepto CDN)
  "CUCU-PROD-015": [
    "/products/CUCU-PROD-015.webp",
  ],

  // Spinach (Palak) 250 g (Zepto CDN)
  "SPIN-PROD-016": [
    "/products/SPIN-PROD-016.webp",
  ],

  // Green Peas (Matar) 500 g (Zepto CDN)
  "GREE-PROD-017": [
    "/products/GREE-PROD-017.webp",
  ],

  // Bottle Gourd (Lauki / Ghiya) 1 pc (Zepto CDN)
  "BOTT-PROD-018": [
    "/products/BOTT-PROD-018.webp",
  ],

  // Bitter Gourd (Karela) 500 g (Zepto CDN)
  "BITT-PROD-019": [
    "/products/BITT-PROD-019.webp",
  ],

  // Fresh Mint Leaves (Pudina) 100 g (Zepto CDN)
  "MINT-PROD-020": [
    "/products/MINT-PROD-020.webp",
  ],

  // Beetroot (Chukandar) 500 g (Zepto CDN)
  "BEET-PROD-021": [
    "/products/BEET-PROD-021.webp",
  ],

  // Fresh Coconut (Nariyal) 1 pc (Zepto CDN)
  "COCO-PROD-022": [
    "/products/COCO-PROD-022.webp",
  ],

  // Sweet Corn (2 pcs) (Zepto CDN)
  "SWEE-PROD-023": [
    "/products/SWEE-PROD-023.webp",
  ],

  // Button Mushrooms 200 g (Zepto CDN)
  "BUTT-PROD-024": [
    "/products/BUTT-PROD-024.webp",
  ],

  // Royal Gala Apple (4 pcs) (Zepto CDN)
  "ROYA-PROD-025": [
    "/products/ROYA-PROD-025.webp",
  ],

  // Pomegranate (Anar) 1 kg (Zepto CDN)
  "POME-PROD-026": [
    "/products/POME-PROD-026.webp",
  ],

  // Nagpur Orange (Santra) 1 kg (Zepto CDN)
  "NAGP-PROD-027": [
    "/products/NAGP-PROD-027.webp",
  ],

  // Papaya Semi-Ripe (1 pc) (Zepto CDN)
  "PAPA-PROD-028": [
    "/products/PAPA-PROD-028.webp",
  ],

  // Sweet Lime (Mosambi) 1 kg (Zepto CDN)
  "SWEE-PROD-029": [
    "/products/SWEE-PROD-029.webp",
  ],

  // Seedless Green Grapes (Angoor) 500 g (Zepto CDN)
  "SEED-PROD-030": [
    "/products/SEED-PROD-030.webp",
  ],

  // Watermelon (Tarbooz) 1 pc (Zepto CDN)
  "WATE-PROD-031": [
    "/products/WATE-PROD-031.webp",
  ],

  // Elaichi Banana (Yellaki) 500 g (Zepto CDN)
  "ELAI-PROD-032": [
    "/products/ELAI-PROD-032.webp",
  ],

  // Custard Apple (Sitaphal) 500 g (Zepto CDN)
  "CUST-PROD-033": [
    "/products/CUST-PROD-033.webp",
  ],

  // Baby Corn 200 g (Zepto CDN)
  "BABY-PROD-034": [
    "/products/BABY-PROD-034.webp",
  ],

  // Kurkure Masala Munch 82 g (Zepto CDN)
  "KURK-SNCK-007": [
    "/products/KURK-SNCK-007.webp",
  ],

  // Britannia Good Day Cashew Biscuits 200 g (Zepto CDN)
  "BRIT-SNCK-008": [
    "/products/BRIT-SNCK-008.webp",
  ],

  // Britannia Marie Gold Biscuits 250 g (Zepto CDN)
  "BRIT-SNCK-009": [
    "/products/BRIT-SNCK-009.webp",
  ],

  // Cadbury Dairy Milk Chocolate 50 g (Zepto CDN)
  "CADB-SNCK-010": [
    "/products/CADB-SNCK-010.webp",
  ],

  // Nestle KitKat 4-Finger 38.5 g (Zepto CDN)
  "NEST-SNCK-011": [
    "/products/NEST-SNCK-011.webp",
  ],

  // Oreo Vanilla Cream Biscuits 120 g (Zepto CDN)
  "OREO-SNCK-012": [
    "/products/OREO-SNCK-012.webp",
  ],

  // Sunfeast Dark Fantasy Choco Fills 300 g (Zepto CDN)
  "SUNF-SNCK-013": [
    "/products/SUNF-SNCK-013.webp",
  ],

  // Haldiram's Khatta Meetha Namkeen 200 g (Zepto CDN)
  "HALD-SNCK-014": [
    "/products/HALD-SNCK-014.webp",
  ],

  // Haldiram's Moong Dal 200 g (Zepto CDN)
  "HALD-SNCK-015": [
    "/products/HALD-SNCK-015.webp",
  ],

  // Yippee! Magic Masala Noodles 240 g (Zepto CDN)
  "YIPP-SNCK-016": [
    "/products/YIPP-SNCK-016.webp",
  ],

  // Lay's Classic Salted Potato Chips 52 g (Zepto CDN)
  "LAYS-SNCK-017": [
    "/products/LAYS-SNCK-017.webp",
  ],

  // Bingo! Tedhe Medhe Masala Tadka 90 g (Zepto CDN)
  "BING-SNCK-018": [
    "/products/BING-SNCK-018.webp",
  ],

  // Act II Butter Popcorn 150 g (Zepto CDN)
  "ACT-SNCK-019": [
    "/products/ACT-SNCK-019.webp",
  ],

  // Bikaji Bhujia Sev 400 g (Zepto CDN)
  "BIKA-SNCK-020": [
    "/products/BIKA-SNCK-020.webp",
  ],

  // Britannia Bourbon Chocolate Cream Biscuits 150 g (Zepto CDN)
  "BRIT-SNCK-021": [
    "/products/BRIT-SNCK-021.webp",
  ],

  // Parle Hide & Seek Chocolate Chip Cookies 120 g (Zepto CDN)
  "PARL-SNCK-022": [
    "/products/PARL-SNCK-022.webp",
  ],

  // Roasted & Salted California Almonds (Badam) 200 g (Zepto CDN)
  "ROAS-SNCK-023": [
    "/products/ROAS-SNCK-023.webp",
  ],

  // Whole Cashews (Kaju) 200 g (Zepto CDN)
  "CASH-SNCK-024": [
    "/products/CASH-SNCK-024.webp",
  ],

  // Kishmish (Raisins) 200 g (Zepto CDN)
  "KISH-SNCK-025": [
    "/products/KISH-SNCK-025.webp",
  ],

  // Phool Makhana (Fox Nuts) 100 g (Zepto CDN)
  "PHOO-SNCK-026": [
    "/products/PHOO-SNCK-026.webp",
  ],

  // Haldiram's Soan Papdi 250 g (Zepto CDN)
  "HALD-SNCK-027": [
    "/products/HALD-SNCK-027.webp",
  ],

  // Kellogg's Corn Flakes 475 g (Zepto CDN)
  "KELL-SNCK-028": [
    "/products/KELL-SNCK-028.webp",
  ],

  // Quaker Rolled Oats 1 kg (Zepto CDN)
  "QUAK-SNCK-029": [
    "/products/QUAK-SNCK-029.webp",
  ],

  // Cadbury 5 Star Chocolate Bar 40 g (Zepto CDN)
  "CADB-SNCK-030": [
    "/products/CADB-SNCK-030.webp",
  ],

  // Ching's Secret Veg Hakka Noodles 150 g (Zepto CDN)
  "CHIN-SNCK-031": [
    "/products/CHIN-SNCK-031.webp",
  ],

  // Maggi Nutri-licious Masala Oats Noodles 292 g (Zepto CDN)
  "MAGG-SNCK-032": [
    "/products/MAGG-SNCK-032.webp",
  ],
  ...
  "ENGL-BAKE-002": [
    "/products/ENGL-BAKE-002.webp",
  ],

  // Britannia Sandwich White Bread 400 g (Zepto CDN)
  "BRIT-BAKE-003": [
    "/products/BRIT-BAKE-003.webp",
  ],

  // English Oven Sandwich Bread 400 g (Zepto CDN)
  "ENGL-BAKE-004": [
    "/products/ENGL-BAKE-004.webp",
  ],

  // English Oven Burger Buns (Pack of 2) (Zepto CDN)
  "ENGL-BAKE-005": [
    "/products/ENGL-BAKE-005.webp",
  ],

  // Britannia Toastea Premium Milk Rusk 200 g (Zepto CDN)
  "BRIT-BAKE-006": [
    "/products/BRIT-BAKE-006.webp",
  ],

  // Britannia Fruit Cake 120 g (Zepto CDN)
  "BRIT-BAKE-007": [
    "/products/BRIT-BAKE-007.webp",
  ],

  // The Health Factory Multi-Protein Bread 250 g (Zepto CDN)
  "HEAL-BAKE-008": [
    "/products/HEAL-BAKE-008.webp",
  ],

  // English Oven Garlic Bread Loaf 200 g (Zepto CDN)
  "ENGL-BAKE-009": [
    "/products/ENGL-BAKE-009.webp",
  ],

  // English Oven Pizza Base (2 pcs) 200 g (Zepto CDN)
  "ENGL-BAKE-010": [
    "/products/ENGL-BAKE-010.webp",
  ],

  // Winkies Swiss Roll Chocolate 100 g (Zepto CDN)
  "WINK-BAKE-011": [
    "/products/WINK-BAKE-011.webp",
  ],

  // English Oven Brown Bread 400 g (Zepto CDN)
  "ENGL-BAKE-012": [
    "/products/ENGL-BAKE-012.webp",
  ],

  // Bakefresh Sweet Coconut Cookies 200 g (Zepto CDN)
  "BAKE-BAKE-013": [
    "/products/BAKE-BAKE-013.webp",
  ],

  // Vim Dishwash Bar 300 g (Zepto CDN)
  "VIM-HHLD-005": [
    "/products/VIM-HHLD-005.webp",
  ],

  // Vim Dishwash Gel Lemon 500 ml (Zepto CDN)
  "VIM-HHLD-006": [
    "/products/VIM-HHLD-006.webp",
  ],

  // Surf Excel Easy Wash Detergent Powder 1 kg (Zepto CDN)
  "SURF-HHLD-007": [
    "/products/SURF-HHLD-007.webp",
  ],

  // Ariel Matic Front Load Detergent 1 kg (Zepto CDN)
  "ARIE-HHLD-008": [
    "/products/ARIE-HHLD-008.webp",
  ],

  // Tide Plus Double Power Detergent 1 kg (Zepto CDN)
  "TIDE-HHLD-009": [
    "/products/TIDE-HHLD-009.webp",
  ],

  // Rin Detergent Bar (Pack of 4) 250 g each (Zepto CDN)
  "RIN-HHLD-010": [
    "/products/RIN-HHLD-010.webp",
  ],

  // Lizol Disinfectant Floor Cleaner Citrus 1 L (Zepto CDN)
  "LIZO-HHLD-011": [
    "/products/LIZO-HHLD-011.webp",
  ],

  // Harpic Power Plus Toilet Cleaner 1 L (Zepto CDN)
  "HARP-HHLD-012": [
    "/products/HARP-HHLD-012.webp",
  ],

  // Colin Glass & Surface Cleaner 500 ml (Zepto CDN)
  "COLI-HHLD-013": [
    "/products/COLI-HHLD-013.webp",
  ],

  // Scotch-Brite Sponge Wipe (Pack of 3) (Zepto CDN)
  "SCOT-HHLD-014": [
    "/products/SCOT-HHLD-014.webp",
  ],

  // Goodknight Gold Flash Mosquito Liquid Refill (Twin Pack) (Zepto CDN)
  "GOOD-HHLD-015": [
    "/products/GOOD-HHLD-015.webp",
  ],

  // Hit Flying Insect Mosquito Killer Spray 400 ml (Zepto CDN)
  "HIT-HHLD-016": [
    "/products/HIT-HHLD-016.webp",
  ],

  // Freshwrap Aluminium Foil 11 m (Zepto CDN)
  "FRES-HHLD-017": [
    "/products/FRES-HHLD-017.webp",
  ],

  // Origami So Soft 2-Ply Kitchen Towels (Pack of 2) (Zepto CDN)
  "ORIG-HHLD-018": [
    "/products/ORIG-HHLD-018.webp",
  ],

  // Garbage Bags Medium (Black, 30 Bags) (Zepto CDN)
  "GARB-HHLD-019": [
    "/products/GARB-HHLD-019.webp",
  ],

  // Comfort After Wash Fabric Conditioner Lily 860 ml (Zepto CDN)
  "COMF-HHLD-020": [
    "/products/COMF-HHLD-020.webp",
  ],

  // Odonil Room Air Freshener Jasmine 50 g (Zepto CDN)
  "ODON-HHLD-021": [
    "/products/ODON-HHLD-021.webp",
  ],

  // Scotch-Brite Heavy Duty Scrub Sponge (Pack of 3) (Zepto CDN)
  "SCOT-HHLD-022": [
    "/products/SCOT-HHLD-022.webp",
  ],

  // Dettol Disinfectant Multi-Use Liquid Lime 1 L (Zepto CDN)
  "DETT-HHLD-023": [
    "/products/DETT-HHLD-023.webp",
  ],

  // Pril Tamarind Dishwash Liquid 750 ml (Zepto CDN)
  "PRIL-HHLD-024": [
    "/products/PRIL-HHLD-024.webp",
  ],

  // Dettol Original Bathing Soap Bar 125 g (Pack of 4) (Zepto CDN)
  "DETT-PCAR-004": [
    "/products/DETT-PCAR-004.webp",
  ],

  // Lifebuoy Total Germ Protection Soap 125 g (Pack of 4) (Zepto CDN)
  "LIFE-PCAR-005": [
    "/products/LIFE-PCAR-005.webp",
  ],

  // Dove Cream Beauty Bathing Bar 100 g (Pack of 3) (Zepto CDN)
  "DOVE-PCAR-006": [
    "/products/DOVE-PCAR-006.webp",
  ],

  // Pears Pure & Gentle Soap 125 g (Pack of 3) (Zepto CDN)
  "PEAR-PCAR-007": [
    "/products/PEAR-PCAR-007.webp",
  ],

  // Lifebuoy Total Handwash Pump 200 ml (Zepto CDN)
  "LIFE-PCAR-008": [
    "/products/LIFE-PCAR-008.webp",
  ],

  // Dettol Liquid Handwash Refill 675 ml (Zepto CDN)
  "DETT-PCAR-009": [
    "/products/DETT-PCAR-009.webp",
  ],

  // Colgate Strong Teeth Toothpaste 300 g (Pack of 2) (Zepto CDN)
  "COLG-PCAR-010": [
    "/products/COLG-PCAR-010.webp",
  ],

  // Colgate MaxFresh Spicy Red Gel Toothpaste 150 g (Zepto CDN)
  "COLG-PCAR-011": [
    "/products/COLG-PCAR-011.webp",
  ],

  // Sensodyne Fresh Gel Sensitive Toothpaste 150 g (Zepto CDN)
  "SENS-PCAR-012": [
    "/products/SENS-PCAR-012.webp",
  ],

  // Close Up Everfresh Red Hot Gel 150 g (Zepto CDN)
  "CLOS-PCAR-013": [
    "/products/CLOS-PCAR-013.webp",
  ],

  // Oral-B Shiny Clean Soft Toothbrush (Pack of 4) (Zepto CDN)
  "ORAL-PCAR-014": [
    "/products/ORAL-PCAR-014.webp",
  ],

  // Head & Shoulders Cool Menthol Anti-Dandruff Shampoo 340 ml (Zepto CDN)
  "HEAD-PCAR-015": [
    "/products/HEAD-PCAR-015.webp",
  ],

  // Clinic Plus Strong & Long Shampoo 340 ml (Zepto CDN)
  "CLIN-PCAR-016": [
    "/products/CLIN-PCAR-016.webp",
  ],

  // Pantene Hairfall Control Shampoo 340 ml (Zepto CDN)
  "PANT-PCAR-017": [
    "/products/PANT-PCAR-017.webp",
  ],

  // Bajaj Almond Drops Non-Sticky Hair Oil 190 ml (Zepto CDN)
  "BAJA-PCAR-018": [
    "/products/BAJA-PCAR-018.webp",
  ],

  // Dabur Amla Hair Oil 275 ml (Zepto CDN)
  "DABU-PCAR-019": [
    "/products/DABU-PCAR-019.webp",
  ],

  // Himalaya Purifying Neem Face Wash 150 ml (Zepto CDN)
  "HIMA-PCAR-020": [
    "/products/HIMA-PCAR-020.webp",
  ],

  // Vaseline Intensive Care Deep Moisture Body Lotion 400 ml (Zepto CDN)
  "VASE-PCAR-021": [
    "/products/VASE-PCAR-021.webp",
  ],

  // Nivea Soft Light Moisturising Cream 100 ml (Zepto CDN)
  "NIVE-PCAR-022": [
    "/products/NIVE-PCAR-022.webp",
  ],

  // Gillette Classic Regular Shaving Foam 200 ml (Zepto CDN)
  "GILL-PCAR-023": [
    "/products/GILL-PCAR-023.webp",
  ],

  // Whisper Ultra Clean Sanitary Pads (XL, 30 Pads) (Zepto CDN)
  "WHIS-PCAR-024": [
    "/products/WHIS-PCAR-024.webp",
  ],
  ...
  "TATA-COND-005": [
    "/products/TATA-COND-005.webp",
  ],

  // Tata Sampann Red Chilli Powder (Lal Mirch) 200 g (Zepto CDN)
  "TATA-COND-006": [
    "/products/TATA-COND-006.webp",
  ],

  // Tata Sampann Coriander Powder (Dhania) 200 g (Zepto CDN)
  "TATA-COND-007": [
    "/products/TATA-COND-007.webp",
  ],

  // Tata Sampann Garam Masala 100 g (Zepto CDN)
  "TATA-COND-008": [
    "/products/TATA-COND-008.webp",
  ],

  // Whole Cumin Seeds (Jeera) 200 g (Zepto CDN)
  "CUMI-COND-009": [
    "/products/CUMI-COND-009.webp",
  ],

  // Mustard Seeds (Rai / Sarson) 200 g (Zepto CDN)
  "MUST-COND-010": [
    "/products/MUST-COND-010.webp",
  ],

  // Catch Compounded Asafoetida (Hing) 50 g (Zepto CDN)
  "CATC-COND-011": [
    "/products/CATC-COND-011.webp",
  ],

  // Ajwain (Carom Seeds) 100 g (Zepto CDN)
  "AJWA-COND-012": [
    "/products/AJWA-COND-012.webp",
  ],

  // Whole Black Pepper (Sabut Kali Mirch) 100 g (Zepto CDN)
  "BLAC-COND-013": [
    "/products/BLAC-COND-013.webp",
  ],

  // Green Cardamom (Chhoti Elaichi) 50 g (Zepto CDN)
  "GREE-COND-014": [
    "/products/GREE-COND-014.webp",
  ],

  // Cloves (Laung) 50 g (Zepto CDN)
  "CLOV-COND-015": [
    "/products/CLOV-COND-015.webp",
  ],

  // Kasuri Methi (Dried Fenugreek Leaves) 100 g (Zepto CDN)
  "KASU-COND-016": [
    "/products/KASU-COND-016.webp",
  ],

  // Kissan Fresh Tomato Ketchup Bottle 950 g (Zepto CDN)
  "KISS-COND-017": [
    "/products/KISS-COND-017.webp",
  ],

  // Maggi Hot & Sweet Chilli Sauce 500 g (Zepto CDN)
  "MAGG-COND-018": [
    "/products/MAGG-COND-018.webp",
  ],

  // Ching's Secret Schezwan Chutney 250 g (Zepto CDN)
  "CHIN-COND-019": [
    "/products/CHIN-COND-019.webp",
  ],

  // Dabur Hommade Ginger Garlic Paste 200 g (Zepto CDN)
  "DABU-COND-020": [
    "/products/DABU-COND-020.webp",
  ],

  // Mother's Recipe Mango Pickle (Aam Ka Achar) 400 g (Zepto CDN)
  "MOTH-COND-021": [
    "/products/MOTH-COND-021.webp",
  ],

  // Tops Mixed Pickle 450 g (Zepto CDN)
  "TOPS-COND-022": [
    "/products/TOPS-COND-022.webp",
  ],

  // Ching's Dark Soy Sauce 200 g (Zepto CDN)
  "CHIN-COND-023": [
    "/products/CHIN-COND-023.webp",
  ],

  // Ching's Secret Green Chilli Sauce 200 g (Zepto CDN)
  "CHIN-COND-024": [
    "/products/CHIN-COND-024.webp",
  ],

  // Apple 20W USB-C Power Adapter (Zepto CDN)
  "APPL-ELEC-002": [
    "/products/APPL-ELEC-002.webp",
  ],

  // Apple 60W USB-C Woven Charge Cable 1m (Zepto CDN)
  "APPL-ELEC-003": [
    "/products/APPL-ELEC-003.webp",
  ],

  // boAt Bassheads 100 Wired in-Ear Earphones with Mic (Zepto CDN)
  "BOAT-ELEC-004": [
    "/products/BOAT-ELEC-004.webp",
  ],

  // Mi 10000mAh 22.5W Fast Charging Power Bank 3i (Zepto CDN)
  "MI-ELEC-005": [
    "/products/MI-ELEC-005.webp",
  ],
...
export const SUBCATEGORY_IMAGES: Record<string, string> = {
  healthy_picks: "/brand/brand_FREE-STPL-011_1.webp",
  olive_cold: "/subcategories/olive_cold.webp",
  oil: "/brand/brand_FORT-STPL-012_1.webp",
...
export const BRAND_IMAGES: Record<string, string[]> = {
  "APPL-ELEC-001": [
    "/brand/brand_APPL-ELEC-001_1.webp",
    "/brand/brand_APPL-ELEC-001_2.webp",
    "/brand/brand_APPL-ELEC-001_3.webp",
    "/brand/brand_APPL-ELEC-001_4.webp",
    "/brand/brand_APPL-ELEC-001_5.webp",
  ],
  "FREE-STPL-011": [
    "/brand/brand_FREE-STPL-011_1.webp",
  ],
...
export function getProductMeta(sku: string, category: string, displayName: string, unitLabel: string): ProductMeta {
  ...
  if (sku.startsWith("OIL-SUN") || sku === "FREE-STPL-017") {
    return {
      brand: "Freedom",
      description:
  ...
  if (sku.startsWith("OIL-MUS") || sku === "FORT-STPL-018") {
    return {
      brand: "Fortune",
      description:
