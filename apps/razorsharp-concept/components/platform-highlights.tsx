...
const challenges=[
 {icon:Search,title:'Too many filters. Too little context.',body:'Start with an occasion, a budget or a spoken request. Let the Ecommerce Store help turn it into a selection.',tag:'DISCOVERY → INTENT'},
