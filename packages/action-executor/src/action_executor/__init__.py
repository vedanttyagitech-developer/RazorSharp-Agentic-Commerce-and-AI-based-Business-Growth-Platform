"""action-executor: executes admitted commands and is the only process that calls Razorpay.
...
point. The handlers are reachable through :mod:`action_executor.handlers` for tests and
for anyone reading the ordering, and the transport through
:mod:`action_executor.transport`.
"""
