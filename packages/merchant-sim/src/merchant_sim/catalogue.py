...
CATALOGUE: Final[tuple[Product, ...]] = (
    ...
    Product(
        ...
        synonyms_latin=("the derma co", "derma co", "sunscreen", "hyaluronic sunscreen", "aqua gel", "spf 50"),
    ),
    Product(
        sku="GRO-PCAR-031",
        ...
        synonyms_latin=("the derma co", "derma co", "salicylic face wash", "face wash", "gel face wash"),
    ),
    # ---- CONDIMENTS (expanded) ----
    Product(
        sku="GRO-COND-005",
