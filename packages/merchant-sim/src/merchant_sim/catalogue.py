...
DELIVERY
--------
``delivery_promise_days`` is the merchant's own promise for one product: the number of
whole days after an order is placed by which it will have arrived, with ``0`` meaning the
same day. It is a promise, not an estimate -- the outer bound the storefront renders as
"Get it by ...".

It is stated in days rather than as a date, and that split is deliberate. This package has
no clock that any decision may depend on (see :mod:`merchant_sim.grounding`), and a date
...
Electronics say ``2``: they ship from a warehouse rather than off those shelves, and they
...
#: Outer bound on a delivery promise. A merchant who types 200 into a catalogue row has
#: typed a typo, and nothing downstream would catch it: the storefront would draw "Get it
#: by" a date seven months out and look like it meant it. A month is already far longer
#: than anything this store sells.
MAX_DELIVERY_PROMISE_DAYS: Final[int] = 30
...
class Product:
    ...
    def __post_init__(self) -> None:
        ...
        if not 0 <= self.delivery_promise_days <= MAX_DELIVERY_PROMISE_DAYS:
            raise ValueError(
                f"{self.sku}: delivery_promise_days must be a whole number of days "
                f"between 0 and {MAX_DELIVERY_PROMISE_DAYS}"
            )
...
CATALOGUE: Final[tuple[Product, ...]] = (
    ...
    # ---- electronics ----------------------------------------------------------
    # The only category the dark store does not deliver the same day: these ship from a
    # warehouse, so they promise two days and every other row in this fixture promises
    # zero. If that ever collapses to one number the field stops being merchant data.
    Product(
        sku="APPL-ELEC-001",
    ...
    Product(
        sku="CETA-PCAR-026",
        name_en="Cetaphil Gentle Skin Cleanser 118 ml",
        name_hi="सेटाफिल जेंटल स्किन क्लींजर 118 मिली",
        category=Category.PERSONAL_CARE,
        unit_label="118 ml",
        list_price=_inr(36200),
        baseline_stock=35,
        tax_bp=1800,
        delivery_promise_days=0,
        synonyms_hi=("सेटाफिल", "क्लींजर", "फेस वॉश"),
        synonyms_latin=("cetaphil", "cleanser", "face wash", "gentle skin cleanser"),
    ),
    Product(
        sku="CETA-PCAR-027",
        name_en="Cetaphil Moisturizing Lotion 118 ml",
        name_hi="सेटाफिल मॉइस्चराइजिंग लोशन 118 मिली",
        category=Category.PERSONAL_CARE,
        unit_label="118 ml",
        list_price=_inr(60200),
        baseline_stock=25,
        tax_bp=1800,
        delivery_promise_days=0,
        synonyms_hi=("सेटाफिल", "मॉइस्चराइज़र", "लोशन"),
        synonyms_latin=("cetaphil", "moisturizing lotion", "lotion", "moisturizer", "body lotion"),
    ),
    Product(
        sku="MINI-PCAR-028",
        name_en="Minimalist 10% Niacinamide Face Serum 10 ml",
        name_hi="मिनिमलिस्ट 10% नियासिनमाइड फेस सीरम 10 मिली",
        category=Category.PERSONAL_CARE,
        unit_label="10 ml",
        list_price=_inr(23700),
        baseline_stock=30,
        tax_bp=1800,
        delivery_promise_days=0,
        synonyms_hi=("मिनिमलिस्ट", "नियासिनमाइड", "सीरम"),
        synonyms_latin=("minimalist", "niacinamide", "face serum", "serum", "niacinamide serum"),
    ),
    Product(
        sku="MINI-PCAR-029",
        name_en="Minimalist Salicylic Acid + LHA 02% Face Cleanser 100 ml",
        name_hi="मिनिमलिस्ट सैलिसिलिक एसिड फेस क्लींजर 100 मिली",
        category=Category.PERSONAL_CARE,
        unit_label="100 ml",
        list_price=_inr(28500),
        baseline_stock=30,
        tax_bp=1800,
        delivery_promise_days=0,
        synonyms_hi=("मिनिमलिस्ट", "सैलिसिलिक एसिड", "फेस क्लींजर"),
        synonyms_latin=("minimalist", "salicylic acid", "face cleanser", "face wash", "cleanser"),
    ),
    Product(
        sku="DERM-PCAR-030",
        name_en="The Derma Co 1% Hyaluronic Sunscreen Aqua Gel 50 g",
        name_hi="द डर्मा को 1% हयालूरोनिक सनस्क्रीन एक्वा जेल 50 ग्राम",
        category=Category.PERSONAL_CARE,
        unit_label="50 g",
        list_price=_inr(42400),
        baseline_stock=40,
        tax_bp=1800,
        delivery_promise_days=0,
        synonyms_hi=("डर्मा को", "सनस्क्रीन", "एक्वा जेल"),
        synonyms_latin=(
            "the derma co",
            "derma co",
            "sunscreen",
    ...
    Product(
        sku="DERM-PCAR-031",
        name_en="The Derma Co 2% Salicylic Acid Gel Face Wash 100 ml",
        name_hi="द डर्मा को 2% सैलिसिलिक एसिड जेल फेस वॉश 100 मिली",
        category=Category.PERSONAL_CARE,
        unit_label="100 ml",
        list_price=_inr(29600),
        baseline_stock=35,
        tax_bp=1800,
        delivery_promise_days=0,
        synonyms_hi=("डर्मा को", "फेस वॉश", "सैलिसिलिक"),
        synonyms_latin=(
            "the derma co",
            "derma co",
            "salicylic face wash",
    ...
    # Expanded quick-commerce demo assortment. Synthetic baseline prices and stock;
    # tax_bp=0 is a demo configuration, not a product GST classification.
    Product(
        sku="RS-FROZ-001",
        name_en="Frozen French Fries",
        name_hi="फ्रोजन फ्रेंच फ्राइज",
        ...
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("फ्रोजन फ्रेंच फ्राइज",),
        synonyms_latin=("fries", "french fries"),
    ),
    Product(
        sku="RS-FROZ-002",
        name_en="Frozen Green Peas",
        name_hi="फ्रोजन हरी मटर",
        category=Category.FROZEN_FOOD,
        unit_label="500 g",
        list_price=_inr(9000),
        baseline_stock=30,
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("फ्रोजन हरी मटर",),
        synonyms_latin=("matar", "frozen peas"),
    ),
    Product(
        sku="RS-FROZ-003",
        name_en="Frozen Veg Momos",
        name_hi="फ्रोजन वेज मोमोज",
        category=Category.FROZEN_FOOD,
        unit_label="400 g",
        list_price=_inr(18000),
        baseline_stock=30,
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("फ्रोजन वेज मोमोज",),
        synonyms_latin=("momos", "dumplings"),
    ),
    Product(
        sku="RS-FROZ-004",
        name_en="Frozen Aloo Tikki",
        name_hi="फ्रोजन आलू टिक्की",
        category=Category.FROZEN_FOOD,
        unit_label="400 g",
        list_price=_inr(12500),
        baseline_stock=30,
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("फ्रोजन आलू टिक्की",),
        synonyms_latin=("aloo tikki",),
    ),
    Product(
        sku="RS-FROZ-005",
        name_en="Frozen Sweet Corn",
        name_hi="फ्रोजन स्वीट कॉर्न",
        category=Category.FROZEN_FOOD,
        unit_label="500 g",
        list_price=_inr(11000),
        baseline_stock=30,
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("फ्रोजन स्वीट कॉर्न",),
        synonyms_latin=("sweet corn", "makka"),
    ),
    Product(
        sku="RS-FROZ-006",
        name_en="Frozen Malabar Paratha",
        name_hi="फ्रोजन मलाबार पराठा",
        category=Category.FROZEN_FOOD,
        unit_label="5 pcs",
        list_price=_inr(12000),
        baseline_stock=30,
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("फ्रोजन मलाबार पराठा",),
        synonyms_latin=("paratha", "parotta"),
    ),
    Product(
        sku="RS-ICE-001",
        name_en="Vanilla Ice Cream Tub",
        name_hi="वनीला आइसक्रीम",
        ...
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("वनीला आइसक्रीम",),
        synonyms_latin=("vanilla ice cream",),
    ),
    Product(
        sku="RS-ICE-002",
        name_en="Chocolate Ice Cream Tub",
        name_hi="चॉकलेट आइसक्रीम",
        category=Category.ICE_CREAM,
        unit_label="750 ml",
        list_price=_inr(22000),
        baseline_stock=30,
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("चॉकलेट आइसक्रीम",),
        synonyms_latin=("chocolate ice cream",),
    ),
    Product(
        sku="RS-ICE-003",
        name_en="Mango Ice Cream Tub",
        name_hi="मैंगो आइसक्रीम",
        category=Category.ICE_CREAM,
        unit_label="750 ml",
        list_price=_inr(21000),
        baseline_stock=30,
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("मैंगो आइसक्रीम",),
        synonyms_latin=("mango ice cream",),
    ),
    Product(
        sku="RS-ICE-004",
        name_en="Strawberry Ice Cream Cup",
        name_hi="स्ट्रॉबेरी आइसक्रीम कप",
        category=Category.ICE_CREAM,
        unit_label="100 ml",
        list_price=_inr(3500),
        baseline_stock=30,
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("स्ट्रॉबेरी आइसक्रीम कप",),
        synonyms_latin=("strawberry ice cream",),
    ),
    Product(
        sku="RS-ICE-005",
        name_en="Butterscotch Ice Cream Cone",
        name_hi="बटरस्कॉच आइसक्रीम कोन",
        category=Category.ICE_CREAM,
        unit_label="120 ml",
        list_price=_inr(4500),
        baseline_stock=30,
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("बटरस्कॉच आइसक्रीम कोन",),
        synonyms_latin=("ice cream cone",),
    ),
    Product(
        sku="RS-ICE-006",
        name_en="Orange Ice Lolly",
        name_hi="ऑरेंज आइस लॉली",
        category=Category.ICE_CREAM,
        unit_label="4 pcs",
        list_price=_inr(10000),
        baseline_stock=30,
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("ऑरेंज आइस लॉली",),
        synonyms_latin=("ice lolly", "orange candy"),
    ),
    Product(
        sku="RS-BABY-001",
        name_en="Baby Diaper Pants Medium",
        name_hi="बेबी डायपर मीडियम",
        category=Category.BABY_CARE,
        unit_label="30 pcs",
        list_price=_inr(39900),
        baseline_stock=30,
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("बेबी डायपर मीडियम",),
        synonyms_latin=("diaper", "nappies", "medium diaper"),
    ),
    Product(
        sku="RS-BABY-002",
        name_en="Baby Diaper Pants Large",
        name_hi="बेबी डायपर लार्ज",
        category=Category.BABY_CARE,
        unit_label="28 pcs",
        list_price=_inr(39900),
        baseline_stock=30,
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("बेबी डायपर लार्ज",),
        synonyms_latin=("diaper", "large diaper"),
    ),
    Product(
        sku="RS-BABY-003",
        name_en="Unscented Baby Wipes",
        name_hi="बेबी वाइप्स",
        category=Category.BABY_CARE,
        unit_label="72 pcs",
        list_price=_inr(14900),
        ...
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("बेबी वाइप्स",),
        synonyms_latin=("baby wipes",),
    ),
    Product(
        sku="RS-BABY-004",
        name_en="Baby Bath Wash",
        name_hi="बेबी बाथ वॉश",
        category=Category.BABY_CARE,
        unit_label="200 ml",
        list_price=_inr(19900),
        baseline_stock=30,
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("बेबी बाथ वॉश",),
        synonyms_latin=("baby wash",),
    ),
    Product(
        sku="RS-BABY-005",
        name_en="Baby Cotton Bibs",
        name_hi="बेबी कॉटन बिब",
        category=Category.BABY_CARE,
        unit_label="3 pcs",
        list_price=_inr(17900),
        baseline_stock=30,
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("बेबी कॉटन बिब",),
        synonyms_latin=("bib", "feeding bib"),
    ),
    Product(
        sku="RS-BABY-006",
        name_en="Baby Feeding Bottle",
        name_hi="बेबी फीडिंग बोतल",
        category=Category.BABY_CARE,
        unit_label="250 ml",
        list_price=_inr(24900),
        baseline_stock=30,
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("बेबी फीडिंग बोतल",),
        synonyms_latin=("feeding bottle",),
    ),
    Product(
        sku="RS-PET-001",
        name_en="Adult Dog Dry Food",
        name_hi="डॉग ड्राई फूड",
        category=Category.PET_CARE,
        unit_label="1 kg",
        list_price=_inr(29900),
        baseline_stock=30,
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("डॉग ड्राई फूड",),
        synonyms_latin=("dog food", "kutte ka khana"),
    ),
    Product(
        sku="RS-PET-002",
        name_en="Adult Cat Dry Food",
        name_hi="कैट ड्राई फूड",
        category=Category.PET_CARE,
        unit_label="1 kg",
        list_price=_inr(34900),
        baseline_stock=30,
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("कैट ड्राई फूड",),
        synonyms_latin=("cat food", "billi ka khana"),
    ),
    Product(
        sku="RS-PET-003",
        name_en="Dog Biscuits",
        name_hi="डॉग बिस्किट",
        category=Category.PET_CARE,
        unit_label="250 g",
        list_price=_inr(12900),
        baseline_stock=30,
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("डॉग बिस्किट",),
        synonyms_latin=("dog treats",),
    ),
    Product(
        sku="RS-PET-004",
        name_en="Cat Wet Food Tuna",
        name_hi="कैट टूना वेट फूड",
        category=Category.PET_CARE,
        unit_label="85 g",
        list_price=_inr(5500),
        baseline_stock=30,
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("कैट टूना वेट फूड",),
        synonyms_latin=("cat wet food",),
    ),
    Product(
        sku="RS-PET-005",
        name_en="Clumping Cat Litter",
        name_hi="कैट लिटर",
        category=Category.PET_CARE,
        unit_label="5 kg",
        list_price=_inr(39900),
        ...
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("कैट लिटर",),
        synonyms_latin=("cat litter",),
    ),
    Product(
        sku="RS-PET-006",
        name_en="Pet Feeding Bowl",
        name_hi="पेट फीडिंग बाउल",
        category=Category.PET_CARE,
        unit_label="1 pc",
        list_price=_inr(14900),
        baseline_stock=30,
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("पेट फीडिंग बाउल",),
        synonyms_latin=("pet bowl",),
    ),
    Product(
        sku="RS-MEAT-001",
        ...
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("चिकन करी कट",),
        synonyms_latin=("chicken", "murga"),
    ),
    Product(
        sku="RS-MEAT-002",
        ...
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("चिकन ब्रेस्ट बोनलेस",),
        synonyms_latin=("chicken breast",),
    ),
    Product(
        sku="RS-MEAT-003",
        name_en="Chicken Mince",
        name_hi="चिकन कीमा",
        category=Category.MEAT_SEAFOOD,
        unit_label="500 g",
        list_price=_inr(23000),
        ...
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("चिकन कीमा",),
        synonyms_latin=("chicken keema",),
    ),
    Product(
        sku="RS-MEAT-004",
        ...
        category=Category.MEAT_SEAFOOD,
        unit_label="500 g",
        list_price=_inr(48000),
        baseline_stock=30,
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("मटन करी कट",),
        synonyms_latin=("mutton", "bakra"),
    ),
    Product(
        sku="RS-MEAT-005",
        name_en="Rohu Fish Steaks",
        name_hi="रोहू मछली",
        category=Category.MEAT_SEAFOOD,
        unit_label="500 g",
        list_price=_inr(21000),
        ...
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("रोहू मछली",),
        synonyms_latin=("rohu", "machhli", "fish"),
    ),
    Product(
        sku="RS-MEAT-006",
        name_en="Cleaned Prawns",
        name_hi="साफ झींगे",
        category=Category.MEAT_SEAFOOD,
        unit_label="250 g",
        list_price=_inr(28000),
        baseline_stock=30,
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("साफ झींगे",),
        synonyms_latin=("prawns", "jhinga"),
    ),
    Product(
        sku="RS-BRKF-001",
        name_en="Corn Flakes Original",
        name_hi="कॉर्न फ्लेक्स",
        ...
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("कॉर्न फ्लेक्स",),
        synonyms_latin=("cornflakes", "cereal"),
    ),
    Product(
        sku="RS-BRKF-002",
        name_en="Rolled Oats",
        ...
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("रोल्ड ओट्स",),
        synonyms_latin=("rolled oats",),
    ),
    Product(
        sku="RS-BRKF-003",
        name_en="Chocolate Breakfast Cereal",
        name_hi="चॉकलेट ब्रेकफास्ट सीरियल",
        category=Category.BREAKFAST,
        unit_label="375 g",
        list_price=_inr(21000),
        baseline_stock=30,
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("चॉकलेट ब्रेकफास्ट सीरियल",),
        synonyms_latin=("choco cereal",),
    ),
    Product(
        sku="RS-BRKF-004",
        name_en="Fruit and Nut Muesli",
        name_hi="फ्रूट नट म्यूसली",
        category=Category.BREAKFAST,
        unit_label="400 g",
        list_price=_inr(29900),
        baseline_stock=30,
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("फ्रूट नट म्यूसली",),
        synonyms_latin=("muesli",),
    ),
    Product(
        sku="RS-BRKF-005",
        name_en="Instant Poha Mix",
        name_hi="इंस्टेंट पोहा मिक्स",
        category=Category.BREAKFAST,
        unit_label="200 g",
        list_price=_inr(6500),
        baseline_stock=30,
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("इंस्टेंट पोहा मिक्स",),
        synonyms_latin=("poha mix",),
    ),
    Product(
        sku="RS-BRKF-006",
        name_en="Pancake Mix",
        name_hi="पैनकेक मिक्स",
        category=Category.BREAKFAST,
        unit_label="250 g",
        list_price=_inr(14900),
        baseline_stock=30,
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("पैनकेक मिक्स",),
        synonyms_latin=("pancake",),
    ),
    Product(
        sku="RS-DRY-001",
        name_en="Whole Almonds",
        name_hi="साबुत बादाम",
        category=Category.DRY_FRUITS,
        unit_label="200 g",
        list_price=_inr(19900),
        baseline_stock=30,
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("साबुत बादाम",),
        synonyms_latin=("almonds", "badam"),
    ),
    Product(
        sku="RS-DRY-002",
        name_en="Whole Cashews",
        name_hi="साबुत काजू",
        category=Category.DRY_FRUITS,
        unit_label="200 g",
        list_price=_inr(24900),
        ...
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("साबुत काजू",),
        synonyms_latin=("cashews", "kaju"),
    ),
    Product(
        sku="RS-DRY-003",
        name_en="Golden Raisins",
        name_hi="किशमिश",
        category=Category.DRY_FRUITS,
        unit_label="200 g",
        list_price=_inr(9900),
        ...
        delivery_promise_days=0,
        synonyms_hi=("किशमिश",),
        synonyms_latin=("raisins", "kishmish"),
    ),
    Product(
        sku="RS-DRY-004",
        name_en="Walnut Kernels",
        name_hi="अखरोट गिरी",
        category=Category.DRY_FRUITS,
        unit_label="200 g",
        list_price=_inr(29900),
        ...
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("अखरोट गिरी",),
        synonyms_latin=("walnuts", "akhrot"),
    ),
    Product(
        sku="RS-DRY-005",
        ...
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("भुना पिस्ता",),
        synonyms_latin=("pistachios", "pista"),
    ),
    Product(
        sku="RS-DRY-006",
        name_en="Seedless Dates",
        name_hi="बीज रहित खजूर",
        category=Category.DRY_FRUITS,
        unit_label="500 g",
        list_price=_inr(17900),
        baseline_stock=30,
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("बीज रहित खजूर",),
        synonyms_latin=("dates", "khajoor"),
    ),
    Product(
        sku="RS-BEAUT-001",
        name_en="Matte Lipstick Rose",
        name_hi="मैट लिपस्टिक रोज",
        ...
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("मैट लिपस्टिक रोज",),
        synonyms_latin=("lipstick",),
    ),
    Product(
        sku="RS-BEAUT-002",
        name_en="Black Kajal Pencil",
        name_hi="ब्लैक काजल",
        category=Category.BEAUTY,
        unit_label="0.35 g",
        list_price=_inr(12900),
        ...
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("ब्लैक काजल",),
        synonyms_latin=("kajal", "eyeliner"),
    ),
    Product(
        sku="RS-BEAUT-003",
        name_en="Nail Polish Berry",
        name_hi="बेरी नेल पॉलिश",
        category=Category.BEAUTY,
        unit_label="8 ml",
        list_price=_inr(9900),
        baseline_stock=30,
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("बेरी नेल पॉलिश",),
        synonyms_latin=("nail polish",),
    ),
    Product(
        sku="RS-BEAUT-004",
        name_en="Micellar Cleansing Water",
        name_hi="मिसेलर क्लेंजिंग वॉटर",
        category=Category.BEAUTY,
        unit_label="125 ml",
        list_price=_inr(19900),
        baseline_stock=30,
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("मिसेलर क्लेंजिंग वॉटर",),
        synonyms_latin=("makeup remover",),
    ),
    Product(
        sku="RS-BEAUT-005",
        name_en="Cotton Makeup Pads",
        name_hi="कॉटन मेकअप पैड",
        category=Category.BEAUTY,
        unit_label="80 pcs",
        list_price=_inr(9900),
        baseline_stock=30,
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("कॉटन मेकअप पैड",),
        synonyms_latin=("cotton pads",),
    ),
    Product(
        sku="RS-BEAUT-006",
        name_en="Makeup Brush Set",
        name_hi="मेकअप ब्रश सेट",
        category=Category.BEAUTY,
        unit_label="5 pcs",
        list_price=_inr(24900),
        baseline_stock=30,
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("मेकअप ब्रश सेट",),
        synonyms_latin=("makeup brushes",),
    ),
    Product(
        sku="RS-HAIR-001",
        name_en="Coconut Hair Oil",
        name_hi="नारियल हेयर ऑयल",
        ...
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("नारियल हेयर ऑयल",),
        synonyms_latin=("hair oil", "nariyal tel"),
    ),
    Product(
        sku="RS-HAIR-002",
        name_en="Daily Care Shampoo",
        name_hi="डेली केयर शैम्पू",
        category=Category.HAIR_CARE,
        unit_label="340 ml",
        list_price=_inr(24900),
        baseline_stock=30,
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("डेली केयर शैम्पू",),
        synonyms_latin=("shampoo",),
    ),
    Product(
        sku="RS-HAIR-003",
        name_en="Smooth Hair Conditioner",
        name_hi="हेयर कंडीशनर",
        category=Category.HAIR_CARE,
        unit_label="180 ml",
        list_price=_inr(17900),
        baseline_stock=30,
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("हेयर कंडीशनर",),
        synonyms_latin=("conditioner",),
    ),
    Product(
        sku="RS-HAIR-004",
        name_en="Hair Styling Gel",
        name_hi="हेयर स्टाइलिंग जेल",
        category=Category.HAIR_CARE,
        unit_label="100 g",
        list_price=_inr(9900),
        baseline_stock=30,
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("हेयर स्टाइलिंग जेल",),
        synonyms_latin=("hair gel",),
    ),
    Product(
        sku="RS-HAIR-005",
        name_en="Wide Tooth Comb",
        name_hi="चौड़े दांतों की कंघी",
        category=Category.HAIR_CARE,
        unit_label="1 pc",
        list_price=_inr(5900),
        baseline_stock=30,
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("चौड़े दांतों की कंघी",),
        synonyms_latin=("comb", "kanghi"),
    ),
    Product(
        sku="RS-HAIR-006",
        name_en="Hair Ties Black",
        name_hi="ब्लैक हेयर टाई",
        category=Category.HAIR_CARE,
        unit_label="12 pcs",
        list_price=_inr(6900),
        baseline_stock=30,
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("ब्लैक हेयर टाई",),
        synonyms_latin=("hair ties", "rubber band"),
    ),
    Product(
        sku="RS-ORAL-001",
        name_en="Mint Toothpaste",
        name_hi="मिंट टूथपेस्ट",
        ...
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("मिंट टूथपेस्ट",),
        synonyms_latin=("toothpaste", "manjan"),
    ),
    Product(
        sku="RS-ORAL-002",
        name_en="Soft Toothbrush Twin Pack",
        name_hi="सॉफ्ट टूथब्रश",
        category=Category.ORAL_CARE,
        unit_label="2 pcs",
        list_price=_inr(7900),
        baseline_stock=30,
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("सॉफ्ट टूथब्रश",),
        synonyms_latin=("toothbrush",),
    ),
    Product(
        sku="RS-ORAL-003",
        name_en="Mint Mouthwash",
        name_hi="मिंट माउथवॉश",
        category=Category.ORAL_CARE,
        unit_label="250 ml",
        list_price=_inr(14900),
        baseline_stock=30,
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("मिंट माउथवॉश",),
        synonyms_latin=("mouthwash",),
    ),
    Product(
        sku="RS-ORAL-004",
        name_en="Waxed Dental Floss",
        name_hi="डेंटल फ्लॉस",
        category=Category.ORAL_CARE,
        unit_label="50 m",
        list_price=_inr(9900),
        ...
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("डेंटल फ्लॉस",),
        synonyms_latin=("floss",),
    ),
    Product(
        sku="RS-ORAL-005",
        name_en="Stainless Steel Tongue Cleaner",
        name_hi="स्टील जीभ क्लीनर",
        category=Category.ORAL_CARE,
        unit_label="1 pc",
        list_price=_inr(4900),
        baseline_stock=30,
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("स्टील जीभ क्लीनर",),
        synonyms_latin=("tongue cleaner",),
    ),
    Product(
        sku="RS-ORAL-006",
        name_en="Travel Toothbrush Case",
        name_hi="टूथब्रश केस",
        category=Category.ORAL_CARE,
        unit_label="1 pc",
        list_price=_inr(3900),
        baseline_stock=30,
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("टूथब्रश केस",),
        synonyms_latin=("toothbrush case",),
    ),
    Product(
        sku="RS-FEM-001",
        name_en="Sanitary Pads XL",
        name_hi="सैनिटरी पैड एक्सएल",
        category=Category.FEMININE_CARE,
        unit_label="20 pcs",
        list_price=_inr(17900),
        baseline_stock=30,
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("सैनिटरी पैड एक्सएल",),
        synonyms_latin=("sanitary pads", "pads"),
    ),
    Product(
        sku="RS-FEM-002",
        name_en="Overnight Sanitary Pads",
        name_hi="ओवरनाइट सैनिटरी पैड",
        category=Category.FEMININE_CARE,
        unit_label="10 pcs",
        list_price=_inr(14900),
        baseline_stock=30,
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("ओवरनाइट सैनिटरी पैड",),
        synonyms_latin=("night pads",),
    ),
    Product(
        sku="RS-FEM-003",
        name_en="Panty Liners",
        name_hi="पैंटी लाइनर",
        category=Category.FEMININE_CARE,
        unit_label="30 pcs",
        list_price=_inr(9900),
        ...
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("पैंटी लाइनर",),
        synonyms_latin=("panty liners",),
    ),
    Product(
        sku="RS-FEM-004",
        name_en="Period Disposal Bags",
        name_hi="पीरियड डिस्पोजल बैग",
        category=Category.FEMININE_CARE,
        unit_label="30 pcs",
        list_price=_inr(7900),
        baseline_stock=30,
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("पीरियड डिस्पोजल बैग",),
        synonyms_latin=("disposal bags",),
    ),
    Product(
        sku="RS-FEM-005",
        name_en="Hot Water Bag",
        name_hi="गर्म पानी की थैली",
        category=Category.FEMININE_CARE,
        unit_label="1 pc",
        list_price=_inr(19900),
        baseline_stock=30,
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("गर्म पानी की थैली",),
        synonyms_latin=("hot water bag",),
    ),
    Product(
        sku="RS-FEM-006",
        name_en="Reusable Cotton Pads",
        name_hi="रीयूजेबल कॉटन पैड",
        category=Category.FEMININE_CARE,
        unit_label="3 pcs",
        list_price=_inr(24900),
        baseline_stock=30,
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("रीयूजेबल कॉटन पैड",),
        synonyms_latin=("reusable pads",),
    ),
    Product(
        sku="RS-KTCH-001",
        name_en="Aluminium Foil Roll",
        name_hi="एल्युमिनियम फॉइल",
        ...
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("एल्युमिनियम फॉइल",),
        synonyms_latin=("foil",),
    ),
    Product(
        sku="RS-KTCH-002",
        name_en="Food Cling Wrap",
        name_hi="फूड क्लिंग रैप",
        category=Category.KITCHEN,
        unit_label="30 m",
        list_price=_inr(12900),
        baseline_stock=30,
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("फूड क्लिंग रैप",),
        synonyms_latin=("cling film", "wrap"),
    ),
    Product(
        sku="RS-KTCH-003",
        name_en="Baking Paper Roll",
        name_hi="बेकिंग पेपर",
        category=Category.KITCHEN,
        unit_label="10 m",
        list_price=_inr(11900),
        baseline_stock=30,
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("बेकिंग पेपर",),
        synonyms_latin=("baking paper",),
    ),
    Product(
        sku="RS-KTCH-004",
        name_en="Steel Lunch Box",
        name_hi="स्टील लंच बॉक्स",
        category=Category.KITCHEN,
        unit_label="750 ml",
        list_price=_inr(29900),
        baseline_stock=30,
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("स्टील लंच बॉक्स",),
        synonyms_latin=("lunch box", "tiffin"),
    ),
    Product(
        sku="RS-KTCH-005",
        name_en="Food Storage Containers",
        name_hi="फूड स्टोरेज डिब्बे",
        category=Category.KITCHEN,
        unit_label="3 pcs",
        list_price=_inr(24900),
        baseline_stock=30,
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("फूड स्टोरेज डिब्बे",),
        synonyms_latin=("storage container", "dabba"),
    ),
    Product(
        sku="RS-KTCH-006",
        name_en="Vegetable Peeler",
        name_hi="सब्जी छीलने वाला पीलर",
        category=Category.KITCHEN,
        unit_label="1 pc",
        list_price=_inr(6900),
        baseline_stock=30,
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("सब्जी छीलने वाला पीलर",),
        synonyms_latin=("peeler",),
    ),
    Product(
        sku="RS-STAT-001",
        name_en="Ruled Notebook A4",
        name_hi="रूल्ड नोटबुक",
        category=Category.STATIONERY,
        unit_label="200 pages",
        list_price=_inr(7900),
        baseline_stock=30,
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("रूल्ड नोटबुक",),
        synonyms_latin=("notebook", "copy"),
    ),
    Product(
        sku="RS-STAT-002",
        name_en="Blue Ball Pens",
        name_hi="ब्लू बॉल पेन",
        category=Category.STATIONERY,
        unit_label="10 pcs",
        list_price=_inr(9900),
        baseline_stock=30,
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("ब्लू बॉल पेन",),
        synonyms_latin=("pen", "blue pen"),
    ),
    Product(
        sku="RS-STAT-003",
        name_en="HB Pencil Set",
        name_hi="एचबी पेंसिल",
        category=Category.STATIONERY,
        unit_label="10 pcs",
        list_price=_inr(5900),
        ...
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("एचबी पेंसिल",),
        synonyms_latin=("pencil",),
    ),
    Product(
        sku="RS-STAT-004",
        name_en="Eraser and Sharpener Set",
        name_hi="रबर शार्पनर सेट",
        category=Category.STATIONERY,
        unit_label="4 pcs",
        list_price=_inr(3900),
        baseline_stock=30,
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("रबर शार्पनर सेट",),
        synonyms_latin=("eraser", "sharpener"),
    ),
    Product(
        sku="RS-STAT-005",
        name_en="Sticky Notes Yellow",
        name_hi="पीले स्टिकी नोट्स",
        category=Category.STATIONERY,
        unit_label="100 sheets",
        list_price=_inr(4900),
        baseline_stock=30,
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("पीले स्टिकी नोट्स",),
        synonyms_latin=("sticky notes",),
    ),
    Product(
        sku="RS-STAT-006",
        name_en="A4 Copier Paper",
        name_hi="ए4 कॉपियर पेपर",
        category=Category.STATIONERY,
        unit_label="500 sheets",
        list_price=_inr(29900),
        baseline_stock=30,
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("ए4 कॉपियर पेपर",),
        synonyms_latin=("printer paper",),
    ),
    Product(
        sku="RS-TOYS-001",
        name_en="Building Blocks Set",
        name_hi="बिल्डिंग ब्लॉक सेट",
        ...
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("बिल्डिंग ब्लॉक सेट",),
        synonyms_latin=("building blocks",),
    ),
    Product(
        sku="RS-TOYS-002",
        name_en="Colouring Book",
        name_hi="कलरिंग बुक",
        category=Category.TOYS,
        unit_label="32 pages",
        list_price=_inr(7900),
        ...
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("कलरिंग बुक",),
        synonyms_latin=("colouring book",),
    ),
    Product(
        sku="RS-TOYS-003",
        name_en="Wax Crayons",
        name_hi="वैक्स क्रेयॉन",
        category=Category.TOYS,
        unit_label="24 pcs",
        list_price=_inr(9900),
        baseline_stock=30,
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("वैक्स क्रेयॉन",),
        synonyms_latin=("crayons",),
    ),
    Product(
        sku="RS-TOYS-004",
        name_en="Ludo and Snakes Board Game",
        name_hi="लूडो सांप सीढ़ी",
        category=Category.TOYS,
        unit_label="1 set",
        list_price=_inr(14900),
        baseline_stock=30,
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("लूडो सांप सीढ़ी",),
        synonyms_latin=("ludo", "snakes ladders"),
    ),
    Product(
        sku="RS-TOYS-005",
        name_en="Soft Toy Teddy Bear",
        name_hi="टेडी बियर",
        category=Category.TOYS,
        unit_label="1 pc",
        list_price=_inr(24900),
        ...
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("टेडी बियर",),
        synonyms_latin=("teddy", "soft toy"),
    ),
    Product(
        sku="RS-TOYS-006",
        name_en="Bubble Solution Wand",
        name_hi="बबल सॉल्यूशन वैंड",
        category=Category.TOYS,
        unit_label="100 ml",
        list_price=_inr(4900),
        baseline_stock=30,
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("बबल सॉल्यूशन वैंड",),
        synonyms_latin=("bubbles",),
    ),
    Product(
        sku="RS-FIT-001",
        name_en="Yoga Mat",
        ...
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("योगा मैट",),
        synonyms_latin=("yoga mat",),
    ),
    Product(
        sku="RS-FIT-002",
        name_en="Skipping Rope",
        name_hi="स्किपिंग रोप",
        category=Category.FITNESS,
        unit_label="1 pc",
        list_price=_inr(14900),
        baseline_stock=30,
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("स्किपिंग रोप",),
        synonyms_latin=("skipping rope",),
    ),
    Product(
        sku="RS-FIT-003",
        name_en="Resistance Band Light",
        name_hi="लाइट रेजिस्टेंस बैंड",
        category=Category.FITNESS,
        unit_label="1 pc",
        list_price=_inr(19900),
        baseline_stock=30,
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("लाइट रेजिस्टेंस बैंड",),
        synonyms_latin=("resistance band",),
    ),
    Product(
        sku="RS-FIT-004",
        name_en="Steel Sports Bottle",
        name_hi="स्टील स्पोर्ट्स बोतल",
        category=Category.FITNESS,
        unit_label="1 L",
        list_price=_inr(29900),
        baseline_stock=30,
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("स्टील स्पोर्ट्स बोतल",),
        synonyms_latin=("sports bottle",),
    ),
    Product(
        sku="RS-FIT-005",
        name_en="Cotton Wrist Sweatbands",
        name_hi="कॉटन रिस्टबैंड",
        category=Category.FITNESS,
        unit_label="2 pcs",
        list_price=_inr(9900),
        baseline_stock=30,
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("कॉटन रिस्टबैंड",),
        synonyms_latin=("sweatband",),
    ),
    Product(
        sku="RS-FIT-006",
        name_en="Grip Strengthener",
        name_hi="ग्रिप स्ट्रेंथनर",
        category=Category.FITNESS,
        unit_label="1 pc",
        list_price=_inr(14900),
        baseline_stock=30,
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("ग्रिप स्ट्रेंथनर",),
        synonyms_latin=("hand grip",),
    ),
    Product(
        sku="RS-PUJA-001",
        name_en="Sandal Incense Sticks",
        name_hi="चंदन अगरबत्ती",
        ...
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("चंदन अगरबत्ती",),
        synonyms_latin=("agarbatti", "incense"),
    ),
    Product(
        sku="RS-PUJA-002",
        name_en="Cotton Puja Wicks",
        name_hi="पूजा रुई बत्ती",
        category=Category.PUJA,
        unit_label="100 pcs",
        list_price=_inr(3900),
        baseline_stock=30,
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("पूजा रुई बत्ती",),
        synonyms_latin=("batti", "cotton wick"),
    ),
    Product(
        sku="RS-PUJA-003",
        name_en="Clay Diyas",
        name_hi="मिट्टी के दीये",
        category=Category.PUJA,
        unit_label="12 pcs",
        list_price=_inr(7900),
        baseline_stock=30,
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("मिट्टी के दीये",),
        synonyms_latin=("diya", "deepak"),
    ),
    Product(
        sku="RS-PUJA-004",
        name_en="Puja Camphor",
        name_hi="पूजा कपूर",
        category=Category.PUJA,
        unit_label="50 g",
        list_price=_inr(7900),
        ...
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("पूजा कपूर",),
        synonyms_latin=("kapoor", "camphor"),
    ),
    Product(
        sku="RS-PUJA-005",
        name_en="Roli and Chawal Set",
        name_hi="रोली चावल सेट",
        category=Category.PUJA,
        unit_label="1 set",
        list_price=_inr(3900),
        baseline_stock=30,
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("रोली चावल सेट",),
        synonyms_latin=("roli", "chawal"),
    ),
    Product(
        sku="RS-PUJA-006",
        name_en="Marigold Garland",
        name_hi="गेंदे की माला",
        category=Category.PUJA,
        unit_label="1 pc",
        list_price=_inr(6900),
        baseline_stock=30,
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("गेंदे की माला",),
        synonyms_latin=("genda", "mala", "garland"),
    ),
    Product(
        sku="RS-GARD-001",
        name_en="Potting Soil Mix",
        name_hi="गमले की मिट्टी",
        ...
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("गमले की मिट्टी",),
        synonyms_latin=("potting soil", "mitti"),
    ),
    Product(
        sku="RS-GARD-002",
        name_en="Cocopeat Block",
        name_hi="कोकोपीट ब्लॉक",
        category=Category.GARDEN,
        unit_label="650 g",
        list_price=_inr(7900),
        baseline_stock=30,
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("कोकोपीट ब्लॉक",),
        synonyms_latin=("cocopeat",),
    ),
    Product(
        sku="RS-GARD-003",
        name_en="Plant Pot Medium",
        name_hi="मीडियम गमला",
        category=Category.GARDEN,
        unit_label="1 pc",
        list_price=_inr(9900),
        ...
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("मीडियम गमला",),
        synonyms_latin=("plant pot", "gamla"),
    ),
    Product(
        sku="RS-GARD-004",
        name_en="Garden Trowel",
        name_hi="गार्डन खुरपी",
        category=Category.GARDEN,
        unit_label="1 pc",
        list_price=_inr(12900),
        baseline_stock=30,
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("गार्डन खुरपी",),
        synonyms_latin=("trowel", "khurpi"),
    ),
    Product(
        sku="RS-GARD-005",
        name_en="Watering Can",
        name_hi="पानी देने का कैन",
        category=Category.GARDEN,
        unit_label="1 L",
        list_price=_inr(14900),
        baseline_stock=30,
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("पानी देने का कैन",),
        synonyms_latin=("watering can",),
    ),
    Product(
        sku="RS-GARD-006",
        name_en="Coriander Seeds for Planting",
        name_hi="बोने के धनिया बीज",
        category=Category.GARDEN,
        unit_label="20 g",
        list_price=_inr(3900),
        baseline_stock=30,
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("बोने के धनिया बीज",),
        synonyms_latin=("garden seeds", "planting seeds"),
    ),
    Product(
        sku="RS-PARTY-001",
        name_en="Birthday Candles",
        name_hi="बर्थडे मोमबत्ती",
        ...
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("बर्थडे मोमबत्ती",),
        synonyms_latin=("birthday candles",),
    ),
    Product(
        sku="RS-PARTY-002",
        name_en="Party Balloons",
        name_hi="पार्टी गुब्बारे",
        category=Category.PARTY_SUPPLIES,
        unit_label="25 pcs",
        list_price=_inr(7900),
        baseline_stock=30,
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("पार्टी गुब्बारे",),
        synonyms_latin=("balloons", "gubbare"),
    ),
    Product(
        sku="RS-PARTY-003",
        name_en="Paper Party Plates",
        name_hi="पेपर पार्टी प्लेट",
        category=Category.PARTY_SUPPLIES,
        unit_label="25 pcs",
        list_price=_inr(8900),
        baseline_stock=30,
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("पेपर पार्टी प्लेट",),
        synonyms_latin=("paper plates",),
    ),
    Product(
        sku="RS-PARTY-004",
        name_en="Paper Cups",
        ...
        delivery_promise_days=0,
        synonyms_hi=("पेपर कप",),
        synonyms_latin=("paper cups",),
    ),
    Product(
        sku="RS-PARTY-005",
        name_en="Birthday Banner",
        name_hi="बर्थडे बैनर",
        category=Category.PARTY_SUPPLIES,
        unit_label="1 pc",
        list_price=_inr(9900),
        ...
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("बर्थडे बैनर",),
        synonyms_latin=("birthday banner",),
    ),
    Product(
        sku="RS-PARTY-006",
        name_en="Gift Wrapping Paper",
        name_hi="गिफ्ट रैप पेपर",
        category=Category.PARTY_SUPPLIES,
        unit_label="5 sheets",
        list_price=_inr(5900),
        baseline_stock=30,
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("गिफ्ट रैप पेपर",),
        synonyms_latin=("gift wrap",),
    ),
    Product(
        sku="RS-HOME-001",
        name_en="Cotton Hand Towels",
        name_hi="कॉटन हैंड टॉवल",
        category=Category.HOME_FURNISHING,
        unit_label="2 pcs",
        list_price=_inr(14900),
        baseline_stock=30,
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("कॉटन हैंड टॉवल",),
        synonyms_latin=("hand towel",),
    ),
    Product(
        sku="RS-HOME-002",
        name_en="Cotton Bath Towel",
        name_hi="कॉटन बाथ टॉवल",
        category=Category.HOME_FURNISHING,
        unit_label="1 pc",
        list_price=_inr(24900),
        baseline_stock=30,
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("कॉटन बाथ टॉवल",),
        synonyms_latin=("bath towel",),
    ),
    Product(
        sku="RS-HOME-003",
        name_en="Cushion Covers",
        name_hi="कुशन कवर",
        category=Category.HOME_FURNISHING,
        unit_label="2 pcs",
        list_price=_inr(19900),
        ...
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("कुशन कवर",),
        synonyms_latin=("cushion cover",),
    ),
    Product(
        sku="RS-HOME-004",
        name_en="Door Mat",
        ...
        delivery_promise_days=0,
        synonyms_hi=("डोर मैट",),
        synonyms_latin=("doormat",),
    ),
    Product(
        sku="RS-HOME-005",
        name_en="Microfiber Cleaning Cloths",
        name_hi="माइक्रोफाइबर कपड़े",
        category=Category.HOME_FURNISHING,
        unit_label="4 pcs",
        list_price=_inr(12900),
        baseline_stock=30,
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("माइक्रोफाइबर कपड़े",),
        synonyms_latin=("microfiber cloth",),
    ),
    Product(
        sku="RS-HOME-006",
        name_en="Cotton Pillow Cover",
        name_hi="कॉटन तकिया कवर",
        category=Category.HOME_FURNISHING,
        unit_label="2 pcs",
        list_price=_inr(14900),
        baseline_stock=30,
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("कॉटन तकिया कवर",),
        synonyms_latin=("pillow cover",),
    ),
    Product(
        sku="RS-TRVL-001",
        name_en="Travel Toiletry Pouch",
        name_hi="ट्रैवल टॉयलेटरी पाउच",
        ...
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("ट्रैवल टॉयलेटरी पाउच",),
        synonyms_latin=("toiletry bag",),
    ),
    Product(
        sku="RS-TRVL-002",
        name_en="Luggage Name Tags",
        name_hi="लगेज नेम टैग",
        category=Category.TRAVEL,
        unit_label="2 pcs",
        list_price=_inr(7900),
        baseline_stock=30,
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("लगेज नेम टैग",),
        synonyms_latin=("luggage tag",),
    ),
    Product(
        sku="RS-TRVL-003",
        name_en="Travel Neck Pillow",
        name_hi="ट्रैवल नेक पिलो",
        category=Category.TRAVEL,
        unit_label="1 pc",
        list_price=_inr(24900),
        baseline_stock=30,
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("ट्रैवल नेक पिलो",),
        synonyms_latin=("neck pillow",),
    ),
    Product(
        sku="RS-TRVL-004",
        name_en="Travel Eye Mask",
        name_hi="ट्रैवल आई मास्क",
        category=Category.TRAVEL,
        unit_label="1 pc",
        list_price=_inr(9900),
        baseline_stock=30,
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("ट्रैवल आई मास्क",),
        synonyms_latin=("eye mask",),
    ),
    Product(
        sku="RS-TRVL-005",
        name_en="Refillable Travel Bottles",
        name_hi="ट्रैवल बोतल सेट",
        category=Category.TRAVEL,
        unit_label="3 pcs",
        list_price=_inr(12900),
        baseline_stock=30,
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("ट्रैवल बोतल सेट",),
        synonyms_latin=("travel bottles",),
    ),
    Product(
        sku="RS-TRVL-006",
        name_en="Compact Umbrella",
        name_hi="कॉम्पैक्ट छाता",
        category=Category.TRAVEL,
        unit_label="1 pc",
        list_price=_inr(29900),
        baseline_stock=30,
        tax_bp=0,
        delivery_promise_days=0,
        synonyms_hi=("कॉम्पैक्ट छाता",),
        synonyms_latin=("umbrella", "chhata"),
    ),
)
